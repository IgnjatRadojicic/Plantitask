        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditLogs_Groups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.InsertData(
                table: "GroupRoles",
                columns: new[] { "Id", "Description", "DisplayName", "IsActive", "Name", "PermissionLevel" },
                values: new object[,]
                {
                    { 1, "Full control over the group", "Owner", true, "Owner", 100 },
                    { 2, "Can manage members and tasks", "Manager", true, "Manager", 75 },
                    { 3, "Can manage tasks", "Team Lead", true, "TeamLead", 50 },
                    { 4, "Can view and work on tasks", "Member", true, "Member", 25 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "#6c757d", "Low priority task", 1, true, "Low" },
                    { 2, "#0dcaf0", "Medium priority task", 2, true, "Medium" },
                    { 3, "#ffc107", "High priority task", 3, true, "High" },
                    { 4, "#dc3545", "Urgent priority task", 4, true, "Urgent" }
                });

            migrationBuilder.InsertData(
                table: "TaskStatuses",
                columns: new[] { "Id", "Color", "Description", "DisplayName", "DisplayOrder", "IsActive", "Name" },
                values: new object[,]
                {
                    { 1, "#6c757d", "Task has not been started yet", "Not Started", 1, true, "NotStarted" },
                    { 2, "#0dcaf0", "Task is currently being worked on", "In Progress", 2, true, "InProgress" },
                    { 3, "#ffc107", "Task is under review", "Under Review", 3, true, "UnderReview" },
                    { 4, "#198754", "Task is completed", "Completed", 4, true, "Completed" }
                });
